...
const FALLBACK_RULES: Array<[RegExp, string]> = [
  ...
  [/只是为了好玩/, '人物传记'],
  // —— 历史 ——
  [/人类大历史|突厥历法|国史大纲|圣杯与剑/, '历史'],
  // —— 哲学宗教 ——
  [/培根随笔|中国社会中的宗教|信仰与德行/, '哲学宗教'],
  // —— 经济理财 ——（「哈佛经济学家推理系列」别名「奇案中的经济学」，以推理小说讲经济学原理，电商归经济通俗读物）
  [/国家为什么会失败|曼昆经济学|经济学家推理/, '经济理财'],
  // —— 政治军事 ——（央视新闻为中央官方时政媒体，与新华社/人民日报同类）
  [/新华社|人民日报|央视新闻|政事儿|长安街知事|卢克文|波兰球|半月谈/, '政治军事'],
  // —— 文学（书评 / 文学刊物优先于通用报刊规则） ——
  [/人民文学|新京报书评/, '文学'],
  // —— 科学技术 ——（「云海观星社」名为观星，实为半导体/芯片产业科普号）
  [/毕导|云海观星社/, '科学技术'],
  // —— 社会文化（社会学、语言学、公共空间、综合报刊等） ——
  // 「中国新闻网」为综合新闻媒体，与中国新闻周刊 / 北京日报等同类归入社会文化
  [
    /社会学|江村经济|茶馆|强社会与弱国家|理论好用吗|摩登语言学|胭脂与焉支|语言学的邀请|法学教书匠|吉尼斯|账号已迁移|中国新闻周刊|中国新闻社|中国新闻网|北京日报|北京青年报|南方都市报|南风窗|潇湘晨报|中县干部|冯军旗/,
    '社会文化',
  ],
];
